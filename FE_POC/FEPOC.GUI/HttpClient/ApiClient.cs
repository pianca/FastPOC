...
namespace FEPOC.GUI
{
    ...
    public partial class ApiClient 
    {
        ...
        public virtual System.Threading.Tasks.Task<System.Collections.Generic.ICollection<WeatherForecast>> GetForecastsAsync(int amount)
        {
            return GetForecastsAsync(amount, System.Threading.CancellationToken.None);
        }

        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        /// <returns>Success</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<System.Collections.Generic.ICollection<WeatherForecast>> GetForecastsAsync(int amount, System.Threading.CancellationToken cancellationToken)
        {
            if (amount == null)
                throw new System.ArgumentNullException("amount");

            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/forecasts/{amount}");
